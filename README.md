...
>
> ```console
> $ git clone https://github.com/HzaRashid/Issue-Tracker
> ```
>
...
> Run Issue-Tracker using the command below:
> ```console
> $ node app.js
> ```
...
- **[Report Issues](https://github.com/HzaRashid/Issue-Tracker/issues)**: Submit bugs found or log feature requests for the `Issue-Tracker` project.
- **[Submit Pull Requests](https://github.com/HzaRashid/Issue-Tracker/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
- **[Join the Discussions](https://github.com/HzaRashid/Issue-Tracker/discussions)**: Share your insights, provide feedback, or ask questions.
...
<br>
<p align="center">
   <a href="https://github.com{/HzaRashid/Issue-Tracker/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=HzaRashid/Issue-Tracker">
   </a>
</p>
</details>
